...
<c:forEach var="entry" items="${userMap }">
  <tr>
    <td height="23" align="center">
    	...
    	<a href="#" onclick="set('${ entry.value.username }')">${ entry.value.username }</a> 
    	<c:if test="${existUser.type=='admin' and entry.value.type != 'admin'}">
			<a href="userController.do?kick&id=${entry.value.id}">踢下线</a>
		</c:if>
		<!-- -->
	</td>
  </tr>
